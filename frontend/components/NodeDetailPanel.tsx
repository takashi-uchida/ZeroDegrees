...
export default function NodeDetailPanel({
  ...
  return (
    <section className="rounded-[30px] border border-slate-800 bg-slate-950/90 p-6 shadow-[0_20px_80px_rgba(2,6,23,0.2)]">
        ...
        <>
          <div className="mt-5 grid gap-3 sm:grid-cols-3">
            <div className="rounded-2xl border border-slate-800 bg-slate-900 p-4">
              ...
              <p className="mt-2 text-lg font-semibold text-white">{node.distance} shifts</p>
            </div>
            <div className="rounded-2xl border border-slate-800 bg-slate-900 p-4">
              <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-500">Viewpoint shifts</p>
              <p className="mt-2 text-lg font-semibold text-white">{node.metadata.viewpointShifts}</p>
            </div>
            <div className="rounded-2xl border border-slate-800 bg-slate-900 p-4">
              <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-slate-500">Neighbors</p>
              <p className="mt-2 text-lg font-semibold text-white">{neighborCount}</p>
            </div>
          </div>
